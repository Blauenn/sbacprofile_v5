...
import Skeleton_Club_clubRequests from "../Skeleton_Club_clubRequests.component";

const Skeleton_Teacher_Club_information = () => {
	return (
...
export default fade_transition(Skeleton_Teacher_Club_information);